<div class="modal-pop w-full max-w-3xl bg-white rounded-2xl shadow-2xl" data-register-family-modal>
    <div class="flex items-start justify-between px-6 pt-6">
        ...
        <a href="{{ route('dashboard') }}" class="modal-close-btn text-gray-400 hover:text-gray-600 shrink-0" aria-label="Close">
            <i class="ti ti-x" style="font-size: 20px;" aria-hidden="true"></i>
        </a>
    </div>

    <div class="form-errors mx-6 mt-4 bg-red-50 text-red-700 text-sm rounded-lg p-3" @if (! $errors->any()) style="display: none;" @endif>
        {{ $errors->first() }}
    </div>
